...
def getLinksFromTile(tile: tuple, query: dict, increment, session: requests.Session=None): 
    ...
    if(str(links_basic_attributes) != "None"):   
        for attr in links_basic_attributes:
            ...
            links_dict[link_id]['WEIGHT'] = setAttrWeight(links_dict[link_id]['WEIGHT'], attr, query)
...
def setAttrWeight(weight, attributes: dict, features_query: dict, percentage = PERCENTAGE_):
